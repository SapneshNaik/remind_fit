...
public class DBHelper extends SQLiteOpenHelper {
    ...
    private static final String CREATE_USER_ACTIVITY_LIST_TABLE = "create table "+USER_ACTIVITY_TABLE+" ( "+_ID+" INTEGER PRIMARY KEY AUTOINCREMENT, "+USER_ID+" INTEGER REFERENCES "+USER_TABLE+"("+_ID+"), "+ACTIVITY_ID+" INTEGER REFERENCES "+ACTIVITY_TABLE+"("+_ID+"), "+ACTIVITY_COMPLETED_AT+"  TIMESTAMP NOT NULL)";
